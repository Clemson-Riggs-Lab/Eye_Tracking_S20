...
text4 = Label(frame5, text='Eye Tracker Type: Press 1 if you are using a gazepoint eye tracker and 2 if you are using a FOVIO eye tracker')
text4.pack(side=LEFT)


one = Button(window, text="1", width="10", height="3",command=lambda : butter(1))
one.pack(side="top")


two = Button(window, text="2", width="10", height="3", command=lambda : butter(2))
two.pack(side="top")
